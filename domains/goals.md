...
High-level overview of goal progress across all domains. Updated during weekly and monthly reviews.
...
- **Weekly review:** Sunday — assess progress, adjust priorities (via `/gaia-review weekly`)
- **Monthly review:** 1st of month — deeper assessment, goal recalibration (via `/gaia-review monthly`)
- **Quarterly review:** Manual — reassess goals, set next quarter's targets
...
- Run a Q2 retrospective across all domains
- Set Q3 2026 concrete measurable targets per domain, replacing placeholder text with concrete numbers
- Run /gaia-quarter-close to formalize the Q2 to Q3 transition
...
- [Health](health.md) | [Finances](finances.md) | [Languages](languages.md) | [Social](social.md) | [Creative](creative.md)
- [Work Projects](work-projects.md) | [AI Projects](ai-projects.md) | [Business Ideas](business-ideas.md)
- [Calendar](calendar.md) — deadline tracking and review scheduling
